...
\def\italianizerandword{
  \directlua{luatexbase.add_to_callback("pre_linebreak_filter",italianizerandword,"italianizerandword")}}
\def\unitalianizerandword{
  \directlua{luatexbase.remove_from_callback("pre_linebreak_filter","italianizerandword")}}
...
\color{pink!90!black}
  \drawhorse
  \luadraw{0}{
    sloppyline({15,30},{15,60})
    sloppyline({15,60},{25,30})
  }
}
