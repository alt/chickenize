...
\def\tabularasa{    %% TBI – should output just an empty docmunt, but only *after* typesetting. So the content will take exactly the space it needs. Might actualy … be … useful!
  \directlua{}}
\def\untabularasa{
  \directlua{}}
